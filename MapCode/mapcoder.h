...
////////////////////////////////////////////////////////////////
//
//  Initialisation: ALWAYS run init_mapcode_globals(); recommend you also call disambiguate(x) depending on the map that is loaded
//
////////////////////////////////////////////////////////////////

// returns nonzero if error
int init_mapcode_globals(); 
void exit_mapcode_globals();
